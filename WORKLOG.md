...
**👉 次回セッション（別PCの可能性あり）はまず `docs/引継ぎ書_2026-08-22_Day6完了・残作業.md` を読むこと**（上記の残作業を、手順つき・リンクつきでそのまま実行できる形にまとめてある簡易版）。設計の詳しい理由は `docs/実装指示書_Day6_店舗マスタ1箇所化②③.md`・背景は `docs/引継ぎ書_2026-08-22_Day6店舗マスタ1箇所化続き.md`。
